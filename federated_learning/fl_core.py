...
from federated_learning.fl_algorithm import FoolsGold, FLProbe, average_weights, simple_median, trimmed_mean, Krum, \
    FedSVD
    ...
    def run_experiment(self, attack_type='no_attack', malicious_behavior_rate=0,
        ...
        for epoch in tqdm_notebook(range(start_round, self.global_rounds)):
            ...
            if rule == 'median':
                ...
                scores = fl_probe.score(copy.deepcopy(simulation_model),
            ...
            #     plot_updates_components(local_models, clients_types, epoch=epoch+1)
            #     plot_layer_components(local_models, clients_types, epoch=epoch+1, layer = 'linear_weight')
            #     plot_source_target(local_models, clients_types, epoch=epoch+1, classes= [source_class, target_class])
